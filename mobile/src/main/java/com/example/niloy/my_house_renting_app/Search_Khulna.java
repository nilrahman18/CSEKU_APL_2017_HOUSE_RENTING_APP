...
public class Search_Khulna extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Search_Khulna.JSONAsyncTask().execute("http://192.168.0.100/khulna.php");
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position)
                {
                    ...
                    case 1:
                        new Search_Khulna.JSONAsyncTask().execute("http://192.168.0.100/khulna_1_5000.php");
                    ...
                    case 2:
                        new Search_Khulna.JSONAsyncTask().execute("http://192.168.0.100/khulna_5001_10000.php");
                    ...
                    case 3:
                        new Search_Khulna.JSONAsyncTask().execute("http://192.168.0.100/khulna_10001_15000.php");
                    ...
                    case 4:
                        new Search_Khulna.JSONAsyncTask().execute("http://192.168.0.100/khulna_15001_20000.php");

...
public class Search_Dhaka extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Search_Dhaka.JSONAsyncTask().execute("http://192.168.0.100/dhaka.php");
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position)
                {
                    ...
                    case 1:
                        new Search_Dhaka.JSONAsyncTask().execute("http://192.168.0.100/dhaka_1_5000.php");
                    ...
                    case 2:
                        new Search_Dhaka.JSONAsyncTask().execute("http://192.168.0.100/dhaka_5001_10000.php");
                    ...
                    case 3:
                        new Search_Dhaka.JSONAsyncTask().execute("http://192.168.0.100/dhaka_10001_15000.php");
                    ...
                    case 4:
                        new Search_Dhaka.JSONAsyncTask().execute("http://192.168.0.100/dhaka_15001_20000.php");
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(Search_Dhaka.this);

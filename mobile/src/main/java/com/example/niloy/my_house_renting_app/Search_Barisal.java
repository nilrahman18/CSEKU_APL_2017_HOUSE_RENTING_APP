...
public class Search_Barisal extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Search_Barisal.JSONAsyncTask().execute("http://192.168.0.100/barisal.php");
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position)
                {
                    ...
                    case 1:
                        new Search_Barisal.JSONAsyncTask().execute("http://192.168.0.100/barisal_1_5000.php");
                    ...
                    case 2:
                        new Search_Barisal.JSONAsyncTask().execute("http://192.168.0.100/barisal_5001_10000.php");
                    ...
                    case 3:
                        new Search_Barisal.JSONAsyncTask().execute("http://192.168.0.100/barisal_10001_15000.php");
                    ...
                    case 4:
                        new Search_Barisal.JSONAsyncTask().execute("http://192.168.0.100/barisal_15001_20000.php");
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(Search_Barisal.this);

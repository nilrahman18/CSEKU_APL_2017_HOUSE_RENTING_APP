...
$sql = "SELECT * FROM images INNER JOIN uploader_informations ON images.Image_ID = uploader_informations.ID INNER JOIN chittagong ON images.Division = chittagong.Division WHERE Price BETWEEN 15001 AND 20000";

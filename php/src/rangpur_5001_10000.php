...
$sql = "SELECT * FROM images INNER JOIN uploader_informations ON images.Image_ID = uploader_informations.ID INNER JOIN rangpur ON images.Division = rangpur.Division WHERE Price BETWEEN 5001 AND 10000";

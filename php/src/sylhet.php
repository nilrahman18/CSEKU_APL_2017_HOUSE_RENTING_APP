...
$sql = "SELECT * FROM images INNER JOIN uploader_informations ON images.Image_ID = uploader_informations.ID INNER JOIN sylhet ON images.Division = sylhet.Division";

...
$sql = "SELECT * FROM images INNER JOIN uploader_informations ON images.Image_ID = uploader_informations.ID INNER JOIN khulna ON images.Division = khulna.Division WHERE Price BETWEEN 5001 AND 10000";
